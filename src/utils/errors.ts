export enum ErrorCode {
  ...
  DEEPSEEK_WEB_UNAUTHORIZED = 'DEEPSEEK_WEB_UNAUTHORIZED',
  DEEPSEEK_WEB_UNAVAILABLE = 'DEEPSEEK_WEB_UNAVAILABLE',
  DEEPSEEK_WEB_CONVERSATION_NOT_FOUND = 'DEEPSEEK_WEB_CONVERSATION_NOT_FOUND',
  KIMI_WEB_UNAUTHORIZED = 'KIMI_WEB_UNAUTHORIZED',
  KIMI_WEB_UNAVAILABLE = 'KIMI_WEB_UNAVAILABLE',
  KIMI_WEB_CONVERSATION_NOT_FOUND = 'KIMI_WEB_CONVERSATION_NOT_FOUND',
  MINIMAX_WEB_UNAUTHORIZED = 'MINIMAX_WEB_UNAUTHORIZED',
  MINIMAX_WEB_UNAVAILABLE = 'MINIMAX_WEB_UNAVAILABLE',
  MINIMAX_WEB_CONVERSATION_NOT_FOUND = 'MINIMAX_WEB_CONVERSATION_NOT_FOUND',
  ZAI_WEB_UNAUTHORIZED = 'ZAI_WEB_UNAUTHORIZED',
  ZAI_WEB_UNAVAILABLE = 'ZAI_WEB_UNAVAILABLE',
  ZAI_WEB_CONVERSATION_NOT_FOUND = 'ZAI_WEB_CONVERSATION_NOT_FOUND',
}
